...
#include "../../../src/windows/settings.h"
...
QT_MOC_LITERAL(4, 35, 12) // "setClockRate"

    },
    "SettingsDialog\0valueChanged\0\0value\0"
    "setClockRate"
};
...
void SettingsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setClockRate((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (SettingsDialog::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SettingsDialog::valueChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SettingsDialog::valueChanged(int _t1)
{
