...
public:
    ...
    // device_execute_interface overrides
    uint32_t execute_min_cycles() const noexcept {
        return 1;
    }
    uint32_t execute_max_cycles() const noexcept {
        return 12;
    }
    uint32_t execute_input_lines() const noexcept {
        return 2;
    }
    bool execute_input_edge_triggered(int inputnum) const noexcept {
